...
async def send_survey_campaign_emails(
    ...
    for resp, usr in rows:
        ...
        if tenant.website_url:
            links.append(f'<a href="{tenant.website_url}" style="text-decoration: none; color: #64748b; font-size: 10px; margin: 0 6px; font-weight: 500; white-space: nowrap;">Notre Site</a>')
        if tenant.instagram_url:
            links.append(f'<a href="{tenant.instagram_url}" style="text-decoration: none; color: #64748b; font-size: 10px; margin: 0 6px; font-weight: 500; white-space: nowrap;">Insta</a>')
        if tenant.facebook_url:
            links.append(f'<a href="{tenant.facebook_url}" style="text-decoration: none; color: #64748b; font-size: 10px; margin: 0 6px; font-weight: 500; white-space: nowrap;">Facebook</a>')
        
        # Toujours ajouter le lien de désabonnement sécurisé
        links.append(f'<a href="http://localhost:3000/{tenant.slug}/unsubscribe" style="text-decoration: none; color: #64748b; font-size: 10px; margin: 0 6px; font-weight: 500; white-space: nowrap;">Se désabonner</a>')
