            ...
            <main className="flex-1 px-5 pb-5 md:p-12 pt-4 md:pt-12">
                <div className="max-w-3xl mx-auto">
                    <header className="flex items-center justify-between pb-3 border-b border-slate-200 mb-6 gap-4">
                        ...
                        <Link href="/planning" className="flex items-center gap-1 text-[10px] md:text-xs font-medium text-slate-600 hover:text-slate-900 transition-colors group border border-white/60 bg-white/60 backdrop-blur-md rounded-full px-2.5 py-1 shadow-sm hover:bg-white/80">
