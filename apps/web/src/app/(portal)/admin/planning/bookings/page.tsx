...
interface UserOption { id: string; first_name: string; last_name: string; balance?: number; has_unlimited_credits?: boolean; }
...
export default function AdminBookingsPage() {
    ...
    const handleExport = async () => {
        try {
            const allData = await api.getAdminBookings({ include_deleted: true });
