                                ...
                                <div className="bg-white rounded-[32px] border border-slate-100 shadow-sm overflow-hidden p-8">
                                    ...
                                    <div className="flex items-center justify-between mb-8">
                                        ...
                                        <div className="flex items-center gap-4 bg-white px-3 py-1.5 rounded-xl border border-slate-200 shadow-sm">
                                            <button 
                                                onClick={() => {
                                                    const date = getSafeDate(selectedMonthStr);
                                                    date.setMonth(date.getMonth() - 1);
                                                    setSelectedMonthStr(format(date, "yyyy-MM"));
                                                }}
                                            ...
                                            <span className="text-sm font-bold text-slate-700 min-w-[120px] text-center capitalize">
                                                {format(getSafeDate(selectedMonthStr), "MMMM yyyy", { locale: fr })}
                                            </span>
                                            <button 
                                                onClick={() => {
                                                    const date = getSafeDate(selectedMonthStr);
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-4">
                                        <div className="bg-white p-6 rounded-2xl border border-slate-200">
                                            ...
                                            {(!dashboard || (dashboard.income_by_category || []).length === 0) ? (
                                                        ...
                                                        <div key={item.category} className="space-y-1">
                                                            ...
                                                            <div className="h-1.5 w-full bg-slate-200 rounded-full overflow-hidden">
                                                                <div 
                                                                    ...
                                                                    style={{ 
                                                                        width: `${(item.amount / (dashboard?.total_income_cents || 1)) * 100}%`,
                                        ...
                                        <div className="bg-white p-6 rounded-2xl border border-slate-200">
                                            ...
                                            {(!dashboard || (dashboard.expense_by_category || []).length === 0) ? (
                                                <div className="h-32 flex items-center justify-center text-slate-400 italic text-sm">Aucune donnée</div>
                                            ) : (
                                                <div className="space-y-4">
                                                        ...
                                                        <div key={item.category} className="space-y-1">
                                                            ...
                                                            <div className="h-1.5 w-full bg-slate-200 rounded-full overflow-hidden">
                                                                <div 
                                                                    className="h-full rounded-full" 
                                                                    style={{ 
                                                                        width: `${(item.amount / (dashboard?.total_expense_cents || 1)) * 100}%`,
                                        ...
                                        <div className="bg-white p-6 rounded-2xl border border-slate-200 lg:col-span-2">
                                            ...
                                            {(!dashboard || (dashboard.income_by_offer || []).length === 0) ? (
                                                <div className="h-32 flex items-center justify-center text-slate-400 italic text-sm">Aucune donnée</div>
                                            ) : (() => {
