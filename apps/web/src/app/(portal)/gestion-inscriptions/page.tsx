    ...
    if (loading) {
        return (
            <div className="fixed inset-0 bg-white flex flex-col items-center justify-center z-[100]">
                ...
                <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest animate-pulse">Chargement</p>
            </div>
        );
    }

    return (
        <div className="bg-white flex flex-col min-h-screen pb-20 md:pb-0 overflow-x-hidden" style={{ backgroundColor: tenant?.background_color ? `${tenant.background_color}26` : undefined }}>
            ...
            <main className="flex-1 px-5 pb-5 md:p-12 pt-4 md:pt-12">
                <div className="max-w-6xl mx-auto">
                    <header className="flex items-center justify-between pb-3 border-b border-slate-200 mb-3 md:mb-4 gap-4">
                        ...
                        <Link 
                            href="/home" 
                            className="flex items-center gap-1 text-[10px] md:text-xs font-medium text-slate-600 hover:text-slate-900 transition-colors group border border-white/60 bg-white/60 backdrop-blur-md rounded-full px-2.5 py-1 shadow-sm hover:bg-white/80"
                        >
            ...
            <ConfirmModal
                ...
                message="Êtes-vous sûr de vouloir annuler cette séance ? Les inscriptions liées seront également annulées."
                type="warning"
                confirmLabel="Oui, annuler"
                cancelLabel="Non, retourner"
                onConfirm={handleCancelSessionFromModal}
