...
export default function GlobalError({
  ...
  return (
    <html lang="fr" className="h-full">
      <body className={`${inter.className} h-full antialiased bg-gray-50 flex flex-col items-center justify-center p-4`}>
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center border border-gray-100">
          ...
          <p className="text-gray-600 mb-8">
            Une erreur inattendue est survenue au niveau de l'application. Notre équipe technique a été alertée.
          </p>
          <button
            onClick={() => reset()}
